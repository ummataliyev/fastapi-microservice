"""
Routes for Users API endpoints.
"""
...
@router.get(
    ...
    responses={
        UserNotFoundHTTPException.status_code: {
            "model": BaseHTTPExceptionSchema,
            "description": UserNotFoundHTTPException.message,
        },
    },
)
async def get_user(
...
@router.post(
    ...
    responses={
        UserAlreadyExistsHTTPException.status_code: {
            "model": BaseHTTPExceptionSchema,
            "description": UserAlreadyExistsHTTPException.message,
        },
    },
)
